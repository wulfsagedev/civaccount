...
// on every entry.
const STRICT_COUNCILS = new Set(['Bradford', 'Kent', 'Camden', 'Manchester', 'Birmingham', 'Leeds', 'Surrey', 'Cornwall', 'Liverpool', 'Bristol', 'Lancashire', 'Tower Hamlets', 'Hampshire', 'Essex', 'Hertfordshire', 'Sheffield', 'Westminster', 'Nottinghamshire', 'Staffordshire', 'Wiltshire', 'Newcastle upon Tyne', 'Croydon', 'Norfolk', 'West Sussex', 'Derbyshire', 'Lincolnshire', 'Suffolk', 'Leicestershire']);
