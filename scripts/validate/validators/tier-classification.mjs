...
// on every entry.
const STRICT_COUNCILS = new Set(['Bradford', 'Kent', 'Camden', 'Manchester', 'Birmingham', 'Leeds', 'Surrey', 'Cornwall', 'Liverpool', 'Bristol', 'Lancashire', 'Tower Hamlets', 'Hampshire', 'Essex', 'Hertfordshire', 'Sheffield', 'Westminster', 'Nottinghamshire', 'Staffordshire', 'Wiltshire', 'Newcastle upon Tyne', 'Croydon', 'Norfolk', 'West Sussex', 'Derbyshire', 'Lincolnshire', 'Suffolk', 'Leicestershire', 'Cambridgeshire', 'Gloucestershire', 'Worcestershire', 'North Yorkshire', 'Devon', 'East Sussex', 'Oxfordshire', 'Wakefield', 'Doncaster', 'Coventry', 'Bolton', 'Salford', 'Wirral', 'Sandwell', 'Sefton', 'Stockport', 'Wolverhampton', 'Barnsley', 'Solihull', 'St Helens', 'Dudley', 'Oldham', 'York', 'Plymouth', 'Portsmouth', 'Luton', 'Hillingdon', 'Bromley', 'Bexley', 'Greenwich', 'Lambeth', 'Wandsworth', 'Newham', 'Hounslow', 'Brighton & Hove', 'Reading', 'Stoke-on-Trent', 'Telford & Wrekin', 'Southwark', 'Barnet', 'Haringey', 'Merton', 'Cheshire East', 'Cheshire West & Chester', 'Buckinghamshire', 'Bedford', 'Kingston upon Thames', 'Kensington & Chelsea', 'Redbridge', 'Waltham Forest', 'Bath & North East Somerset', 'Halton', 'Bracknell Forest', 'Wokingham', 'Barking & Dagenham', 'Brent', 'Ealing', 'Cumberland', 'Hartlepool', 'Middlesbrough', 'Redcar & Cleveland', 'Westmorland and Furness', 'North Lincolnshire', 'North East Lincolnshire', 'East Riding of Yorkshire', 'Medway Towns', 'Milton Keynes', 'Swindon', 'Darlington', 'Thurrock', 'Derby', 'Leicester', 'Nottingham', 'North Somerset', 'West Berkshire', 'Shropshire', 'Torbay', 'Bournemouth, Christchurch & Poole', 'Lewisham', 'Islington', 'Havering', 'Isle of Wight', 'Central Bedfordshire', 'Windsor & Maidenhead', 'Bury', 'Kirklees', 'North Tyneside', 'Rochdale', 'Wigan', 'Rotherham', 'Walsall', 'Durham', 'Northumberland', 'Harrow', 'Knowsley', 'Sutton', 'Richmond upon Thames', 'Blackpool', 'East Hampshire', 'St Albans', 'West Lindsey', 'Pendle', 'Blaby', 'Erewash', 'Broxtowe', 'Stroud', 'Runnymede', 'West Oxfordshire', 'South Kesteven', 'South Oxfordshire', 'Epping Forest', 'Adur', 'Bassetlaw', 'Braintree', 'Brentwood', 'Burnley', 'Cambridge', 'Chelmsford', 'Cherwell', 'Chesterfield', 'Chorley', 'Colchester', 'Crawley', 'Eastleigh', 'Fenland', 'Gedling', 'Stevenage', 'Staffordshire Moorlands', 'Guildford', 'Havant', 'High Peak', 'Mid Sussex', 'Norwich', 'North Norfolk', 'North Devon', 'Three Rivers', 'Winchester', 'Welwyn Hatfield', 'Sevenoaks', 'Spelthorne', 'Tewkesbury', 'Stratford-on-Avon', 'North West Leicestershire', 'Forest of Dean', 'Hyndburn', 'Ipswich', 'Amber Valley', 'Arun', 'Ashfield', 'Ashford', 'Babergh', 'Basildon', 'Basingstoke & Deane', 'Bolsover', 'Boston', 'Breckland', 'Broadland', 'Bromsgrove', 'Broxbourne', 'Cannock Chase', 'Canterbury', 'Castle Point', 'Charnwood', 'Cheltenham', 'Chichester', 'Cotswold', 'Dacorum', 'Dartford', 'Derbyshire Dales', 'Dover', 'East Cambridgeshire']);
