...
export function validate(councils, _population, report) {
  ...
  const INTENTIONAL_REMOVALS = new Set([
    ...
    // 2026-04-29 Batch-35: 4 districts. Direct fetch.
    ...['Fenland', 'Gedling', 'Stevenage', 'Staffordshire Moorlands'].flatMap(c => [
      `${c}|cabinet`,
      `${c}|council_leader`,
      `${c}|councillor_allowances_detail`,
      `${c}|councillor_basic_allowance`,
    ...
    'Fenland|chief_executive',
    'Gedling|chief_executive',
    'Stevenage|chief_executive',
    // 2026-04-29 Batch-36: 3 districts.
    ...['Guildford', 'Havant', 'High Peak'].flatMap(c => [
      `${c}|cabinet`,
      `${c}|council_leader`,
      `${c}|councillor_allowances_detail`,
      `${c}|councillor_basic_allowance`,
    ...
    // 2026-04-29 Batch-38: 2 districts.
    ...['North Devon', 'Three Rivers'].flatMap(c => [
      `${c}|cabinet`,
      `${c}|council_leader`,
      `${c}|councillor_allowances_detail`,
      `${c}|councillor_basic_allowance`,
    ...
    // 2026-04-29 Batch-39: 2 districts.
    ...['Winchester', 'Welwyn Hatfield'].flatMap(c => [
      `${c}|cabinet`,
      `${c}|council_leader`,
      `${c}|councillor_allowances_detail`,
      `${c}|councillor_basic_allowance`,
    ...
    // 2026-05-01 Batch-42: 1 district.
    ...['North West Leicestershire'].flatMap(c => [
      `${c}|cabinet`,
      `${c}|council_leader`,
      `${c}|councillor_allowances_detail`,
      `${c}|councillor_basic_allowance`,
