...
export default function ContributeBanner() {
  return (
    <section className="relative rounded-xl overflow-hidden">
      ...
      <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#c47a30]/30 via-[#c47a30]/10 to-transparent" />
      <div className="relative card-elevated p-5 sm:p-6 border-[#c47a30]/20 dark:border-[#d4943a]/20">
