 ...
 * Gentle 3D rotation and drift representing money flow.
...
const DataFlowAnimation = memo(function DataFlowAnimation() {
  return (
    <div className="relative w-48 h-48 sm:w-56 sm:h-56 mx-auto perspective-500" aria-hidden="true">
      ...
      {/* Floating coin 1 - top left, slow drift */}
      <div className="absolute top-[8%] left-[12%] animate-float-coin-1">
      ...
      {/* Floating coin 2 - top right, medium drift */}
      <div className="absolute top-[15%] right-[8%] animate-float-coin-2">
      ...
      <div className="absolute bottom-[18%] left-[5%] animate-float-coin-3">
      ...
      {/* Floating coin 4 - bottom right, smallest */}
      <div className="absolute bottom-[12%] right-[15%] animate-float-coin-4">
      ...
      <div className="absolute top-[45%] left-[2%] animate-float-coin-5">
      ...
      <div className="absolute top-[38%] right-[3%] animate-float-coin-6">
      ...
      {/* Center £ token - the focal point */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-card border border-border/70 shadow-xl flex items-center justify-center">
