...
export const alt = 'Most Expensive Council Tax in England 2025-26';
...
export default async function Image() {
  const mostExpensive = councils
    ...
    .reduce((max, c) => c.council_tax!.band_d_2025 > max.council_tax!.band_d_2025 ? c : max);
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <span style={{ fontSize: '48px', fontWeight: 500, color: OG.secondary }}>
            {getCouncilDisplayName(mostExpensive)} has the highest Band D at {formatCurrency(mostExpensive.council_tax!.band_d_2025, { decimals: 2 })}
          </span>
        </div>
