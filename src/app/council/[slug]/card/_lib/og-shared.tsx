  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <span style={{ fontSize: '20px', fontWeight: 700, color: OG_COLORS.text }}>CivAccount</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        {typeName && (
          <span style={{ fontSize: '15px', color: OG_COLORS.muted, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            {typeName}
          </span>
        )}
        <span style={{ fontSize: '18px', color: OG_COLORS.secondary, fontWeight: 500 }}>
          {councilName}
        </span>
      </div>
    </div>
...
export function ogFooter(): ReactElement {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
      <span style={{ fontSize: '16px', color: OG_COLORS.muted }}>2025-26</span>
      <span style={{ fontSize: '16px', color: OG_COLORS.muted }}>civaccount.co.uk</span>
    </div>
  );
}
