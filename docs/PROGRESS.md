...
| **Adur** | SD | 🟢 **North-Star complete (v1.3 strict)** | All phases 0-7 ✓ | 2026-05-01 | Fourth fully-compliant council, first district under v1.3. First to flag personnel-currency drift in Phase 3.6 (CE Catherine Howe → Paul Brewer; Leader stripped → Cllr Jeremy Gardner after Labour gain 23 May 2024). 6 Tier-3 PDFs + 11 PNGs + ADUR-AUDIT.md + manifests/adur.json. **0/5 north-star gaps · 0/0 UX-audit · 4 screenshots / 0 mismatched.** New strips: chief_executive_salary (Howe's 2024-25 figure can't carry to Brewer), UI strip of two-tier district explainer in YourBillCard.tsx (£2,068 = totalBill - thisCouncilBandD derivation). Fixed: population 64,200 → 64,889 (verbatim ONS Mid-2024). 6-member Cabinet populated from democracy.adur-worthing.gov.uk Cmt 138 (Cloudflare-blocked → Wayback). |
| **Bassetlaw** | SD | 🟢 **North-Star complete (v1.3 strict)** | All phases 0-7 ✓ | 2026-05-04 | Fifth fully-compliant council, second district under v1.3. CE David Armiger unchanged; Leader added: Cllr Julie A Leigh (Conservative). 4 new Tier-3 PDFs (final SoA, auditor report, prior SoA, Members' Allowances Constitution Part 7 Nov 2025) + 6 PNGs + BASSETLAW-AUDIT.md + manifests/bassetlaw.json. **0/5 north-star gaps · 0/0 UX-audit · 4/4 verbatim screenshot parity / 0 mismatched.** Fixed: population 118,800 → 124,937 (mid-2022 era → verbatim ONS Mid-2024). 8-member Cabinet from democracy.bassetlaw.moderngov.co.uk Cmt 147 (Cloudflare-blocked → Wayback) — one member (Charles Lindsay Adams) has placeholder portfolio as moderngov page lists no specific brief. Re-applied Adur's UI strip of two-tier explainer (same component fix). |

## All other councils (313)
